...
const diabolicalBrew = new Talent(
  'Diabolical Brew',
...
export const tier3Talents = [
  ...
  new Talent(// 2
    ...
    'If one of your all out attacks is not dodged, you may make an opposed hth M test. If you succeed by at least 2, your opponent gains 1 physical exhaustion.',
    [charMap.M, aptitudes[1]],
    3,
    [[tier1Talents[6]]]
  ),
  ...
  new Talent(// 6
    'Immobile Object',
    'You gain bonus to defensive opposed might tests',
    'You gain a basic bonus of +4 for all opposed M test where you are the responder.',
  ...
  new Talent(// 23
    ...
    [charMap.M, charMap.W, aptitudes[2]],
    3,
  ...
  new Talent(// 24
    ...
    'Whenever you succeed an all out attack roll an additional 1dX of damage for every 2 points of success where X is your M.',
    [charMap.M, aptitudes[1]],
    3,
    [[tier1Talents[6]]]
  ),
