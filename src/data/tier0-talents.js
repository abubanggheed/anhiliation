...
export const tier0Talents = [
  ...
  new Talent(// 1|1
    ...
    [charMap.R, aptitudes[1], aptitudes[2]],
    0,
    []
  ),
  new Talent(// 2|2
  ...
  new Talent(// 5|5
    ...
    'You gain a +2 basic bonus on tests to resist negative effect from a specific hazard. You may take this talent any number of times, each time for a different hazard. The common hazards are: fear, mind control, feedback, toxin, radiation, exposure, force, and starvation. The relevant characteristic aptitude is M or Will depending whether the hazard inflicts physical or mental trauma.',
    [aptitudes[2]],
    0,
    [],
    [[charMap.M, charMap.W]]
