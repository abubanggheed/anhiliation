...
const CareersPage = props => {
  ...
  const pathDescriptions = [
    'Academics are those who have dedicated their lives to the acquisition of knowledge. This may seem an innocent career, but academia is among the most infamous of paths. This is due to the academics who work with magic theory to develop and improve spells. Not only do spells have wondrous effects, but the constant cerebral strain degrades the mental health of academics and their assistants. Some say that the certificate of asylum is the highest degree of academia. Of course, many villages rely on brain power to solve the challenges they face on a regular basis, thus all have a team of academics ready to power the think tank.',
    ...
    'The celebrity is a noble and ancient career. You sole purpose is to be beloved by strangers.  To that end, your life is one laid open for as many as possible to see, that they can bask in your presence to their hearts content. Privacy is not an option.',
    ...
    'To be a goon, is to enact the violent removal of unwanted creatures and people. This is a dreary and dreaded occupation, but for the most part, people are grateful to their goons. Without them, all the enemies, and nasty beasties would rummaging through or chew apart their corpses. Those who command goons command respect, but must take care to treat their goons well less they be violently removed.',
    ...
    'Now we\'re talking. Lobbyists live with a rare and addictive luxury, power. They carve up pieces of the world among each other and sit upon their hidden thrones behind a facade of deception. Lobbyist rarely recognize non-lobbyists as rivals, since if they have one as an enemy, it is surely because another lobbyist making a move behind the scenes.',
